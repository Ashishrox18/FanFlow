...
export default function AssistantPage() {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-background">
      ...
      <main
        className="mx-auto flex w-full max-w-4xl flex-1 flex-col overflow-hidden p-4 sm:p-6 lg:p-8"
        aria-labelledby="assistant-title"
      >
        <header className="mb-4 flex items-center justify-between">
          <div>
            <h1 id="assistant-title" className="text-2xl font-bold tracking-tight">
              AI Assistant
            </h1>
        ...
        >
            ...
            {messages.length === 0 ? (
              <div className="flex h-full flex-col items-center justify-center text-center text-muted-foreground opacity-60">
                ...
                <p className="text-sm mt-2">
                  Try asking for directions, food options, or emergency help.
                </p>
              </div>
            ) : (
          ...
          {/* Input Area */}
          <form onSubmit={handleSubmit} className="border-t border-border/50 bg-background/50 p-4">
